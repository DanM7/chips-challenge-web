...
import { getForceFloorTileAt } from "@engine/msCc1/msCc1Sliding";
import { tryMsCc1Move, msCc1StateFromRun } from "@engine/msCc1/msCc1Movement";
...
import {
  ...
  simulateSingleTap,
} from "./helpers/playSceneForceMoveSimulation";

const level009Path = path.resolve(
  path.dirname(fileURLToPath(import.meta.url)),
  "../public/games/chips-challenge-1/levels/level-009.json",
);
