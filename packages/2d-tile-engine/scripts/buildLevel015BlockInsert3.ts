...
const pushStr = "ULLLUDDRRRDLLDLUUUU";
...
if (blockPos(r) !== "16,9") process.exit(1);
...
if (afterSlide.playerDied) {
  console.error("died in mid");
  process.exit(1);
}

for (const s of ["DRRUDDDDDDD", "DRRUUDDDDDDD", "DRRUDDDDDDDD", "DRRUUDDDDDDDD", "DDRRUDDDDDDD", "DRRRUDDDDDD"]) {
