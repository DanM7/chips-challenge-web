/**
 * From chips2_blue with exit red already open: open blue door, chips0, brown, exit.
 */
...
{
  const seg = bfsPath(r, (x) => x.playerState.chipsRemainingOnMap === 0, "chips0");
  if (!seg) {
    ...
    `${JSON.stringify(
      {
        ...
        boldRouteHint:
          "SW/NW boots; fire/ice; open red+blue doors; chips; brown; exit; 89",
        moveVerified: true,
